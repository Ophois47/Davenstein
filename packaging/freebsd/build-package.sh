...
comment: "Dave Petnick's Wolfenstein 3-D recreation, written in Rust with the Bevy engine"
desc: "A Wolfenstein 3-D recreation by David Petnick, written in Rust with the Bevy engine."
