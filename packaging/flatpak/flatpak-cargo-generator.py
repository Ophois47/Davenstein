#!/usr/bin/env python3
#
# Vendored from https://github.com/flatpak/flatpak-builder-tools
#   path:   cargo/flatpak-cargo-generator.py
#   commit: 737c0085912f9f7dabf9341d4608e2a77a51a73a
# This is a pinned third-party tool. Do not edit locally; to update, re-vendor
# the file from a newer pinned commit. The build regenerates cargo-sources.json
# from Cargo.lock using this script, so the vendored data is never committed.
#
# /// script
# requires-python = ">=3.9"
# dependencies = [
