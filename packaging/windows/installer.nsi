...
Section "Davenstein (required)" SEC_MAIN
  ...
  File "payload\LICENSE.md"
  File "payload\LICENSE-MIT"
  File "payload\LICENSE-APACHE"
  File "payload\COPYRIGHT.md"
  File "payload\THIRD_PARTY_ASSETS.md"
  File "Davenstein.ico"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\COPYRIGHT.md"
  Delete "$INSTDIR\THIRD_PARTY_ASSETS.md"
